    ...
    const people = [
        {
            ...
            img: import.meta.env.VITE_PUBLIC_URL + 'assets/imgs/frater-saladino.png'
        },
        {
            name: 'Frater Fausto', 
            ...
            img: import.meta.env.VITE_PUBLIC_URL + 'assets/imgs/frater-fausto.png'
        },
        {
            ...
            img: import.meta.env.VITE_PUBLIC_URL + 'assets/imgs/frater-fraterno.png'
        },
        {
            name: 'Frater Labu', 
            ...
            img: import.meta.env.VITE_PUBLIC_URL + 'assets/imgs/frater-labu.png'
        },
        {
            ...
            img: import.meta.env.VITE_PUBLIC_URL + 'assets/imgs/frater-enkilius.png'
        },
    ];
                ...
                <IonGrid>
                    <IonRow>
                        {people.map((person, index) => (
                            <IonCol sizeLg="4" sizeMd="6" sizeSm="12" key={index}>
                                <IonCard>
                                    <IonCardHeader>
